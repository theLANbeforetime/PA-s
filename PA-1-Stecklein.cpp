    ...
    while (menuOn != false){
        ...
        switch (userChoice){
            ...
            case 1:
                ...
                //put out results
                cout << "Your number broken into tens is: " << specialTen << endl;
                ...
                //put out results
                cout << "Your new number broken into tens is: " << specialTen << endl;
                ...
                //if number not 99, give something went wrong, else give success line
                    if (finalNum != 99)
                    {
                        ...
                        cout << "Success!\n";
                        cout<< "After adding the reversed minus the original to the new reversed number:\n";
